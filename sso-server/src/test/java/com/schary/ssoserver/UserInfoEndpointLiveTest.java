...
public class UserInfoEndpointLiveTest
{
	...
	{
        /*String accessToken = obtainAccessTokenUsingAuthorizationCodeFlow("user", "user");
        ...
        assertEquals("user", response.jsonPath().get("name"));*/
    }
	
	private String obtainAccessTokenUsingAuthorizationCodeFlow(String username, String password)
	{
        final String authServerUri = "https://localhost:8081/auth";
